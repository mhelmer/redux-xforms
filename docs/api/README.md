...
* [withFilter](/docs/api/withFilter.md)
* [withInitialState](/docs/api/withInitialState.md)
* [withOldStateIfEqual](/docs/api/withOldStateIfEqual.md)
* [withReducer](/docs/api/withReducer.md)
